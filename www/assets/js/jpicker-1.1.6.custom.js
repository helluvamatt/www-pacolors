...
(function($, version)
{
  ...
  $.jPicker =
    {
      List: {}, // hash holding references to each active instance of the control, hashed by the settings.id
        ...
        function()
        {
          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            show =
              function()
              {
                for (var id in $.jPicker.List)
                {
				  $.jPicker.List[id].hide(true);
                }
                color.current.val('ahex', color.active.val('ahex'));
                  ...
                  container.css( // positions must be set and display set to absolute before source code injection or IE will size the container to fit the window
                    {
                      ...
                      position: 'absolute',
                      top: win.position.y == 'screenTop' ? '65px' :
					       win.position.y == 'top' ? (popup.offset().top - 312) + 'px' :
      ...
      window:
        {
          ...
          position:
          {
            ...
            y: 'top' /* acceptable values "top", "bottom", "center", "screenTop" or relative px value */
          },
